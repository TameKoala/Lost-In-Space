...
namespace VRTK
{
    ...
    public class VRTK_BodyPhysics : VRTK_DestinationMarker
    {
        ...
        [Tooltip("The collider will be offset from the floor by this amount. Note that this will require an increase of the headsetYOffset value.")]
        public float playAreaHeightAdjustment = 0.009f;
        ...
        private void CreateCollider()
        {
            ...
            if (bodyCollider == null && createCollider == true)
            {
